  ...
  if (brocfilePath.match(/\.ts$/)) {
    ...
    if (configPath) {
      ...
      options = {
        ...
        compilerOptions: {
          allowJs: true, // Allow JavaScript files to be compiled, allows a .js file to be imported
          esModuleInterop: true, // Allow es/cjs modules to be imported via import foo from 'foo'
          noImplicitAny: false, // Allows "any" object type. Required for importing es modules with no types
          strict: true, // Enable all strict type checking options.
          moduleResolution: 'node', // follow node-modules resolution algorithm
          module: 'commonjs',
          target: 'ES2015', // Node 6 per package.json
          baseUrl: '.',
        },
      };
    }
